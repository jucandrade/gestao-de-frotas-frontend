        ...
        <div className="mt-5 space-y-5">
          <section>
            ...
            <div className="space-y-1.5">
              ...
              <InfoRow label="CPF" value={user.cpf ? formatCpf(user.cpf) : undefined} />
              <InfoRow label="Celular" value={user.mobile ? formatMobile(user.mobile) : undefined} />
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-1.5">
              <InfoRow label="Perfil" value={user.profile?.name} />
            </div>
          </section>
        </div>
