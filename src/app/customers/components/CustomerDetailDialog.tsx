        ...
        <div className="mt-5 space-y-5">
          <section>
            ...
            <div className="space-y-1.5">
              ...
              <InfoRow label="Nome Fantasia" value={customer.tradeName} />
              <InfoRow label="CNPJ" value={customer.cnpj ? formatCnpj(customer.cnpj) : undefined} />
              <InfoRow label="Contato Principal" value={customer.mainContact} />
          ...
          <section>
            ...
            <div className="space-y-1.5">
              ...
              <InfoRow label="Logradouro" value={customer.street} />
              <InfoRow label="Numero" value={customer.number} />
              <InfoRow label="Bairro" value={customer.neighborhood} />
              <InfoRow label="Cidade" value={customer.city} />
              <InfoRow label="Estado" value={customer.state} />
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-1.5">
              ...
              <InfoRow label="Telefone Comercial" value={customer.commercialPhone} />
